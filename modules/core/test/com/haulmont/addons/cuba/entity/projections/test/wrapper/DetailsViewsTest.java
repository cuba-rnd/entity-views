...
import com.haulmont.addons.cuba.entity.projections.test.app.views.sample.ParameterNameOnly;
import com.haulmont.addons.cuba.entity.projections.test.app.views.sample.SampleWithParameters;
...
public class DetailsViewsTest {
    ...
    public void testAddChild() {
        ...
        parent.getParams().add(EntityProjectionWrapper.wrap(child, ParameterNameOnly.class));
